...
export default function AcceptTask({title,description,date,color,category}) {
  return (
    <div className={`flex-shrink-0
        h-full w-[300px] bg-${color} rounded-xl p-5`}>
          ...
          <div className='flex justify-between mt-5'>
            <button className='bg-green-900 py-1 px-2 text-sm text-white rounded-xl'>mark as completd </button>
            <button className=' text-white bg-red-800 py-1 px-2 text-sm rounded-xl'>mark as failed</button>
          </div>  
        </div>
  )
}
