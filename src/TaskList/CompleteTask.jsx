...
export default function CompleteTask({color,title,date,description,category}) {
  return (
    <div className={`flex-shrink-0
        h-full w-[300px] bg-${color} rounded-xl p-5`}>
          ...
          <div className='flex justify-between mt-5'>
            <button className='bg-green-900 py-1 px-2 text-sm text-white rounded-xl w-full'> completed </button>
